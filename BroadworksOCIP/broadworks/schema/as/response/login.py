...
class AuthenticationResponse:
    ...
    def __init__(self, oci_response):
        ...
        try:
            ...
            self.passwordalgorithm = tree.find("command").find("passwordAlgorithm").text
...
class LoginResponse14sp4:
    ...
    def __init__(self, oci_response):
        ...
        try:
            ...
            self.pass_expire =  tree.find("command").find("passwordExpiresDays").text
            self.domain = tree.find("command").find("userDomain").text
            self.serviceproviderid = tree.find("command").find("serviceProviderId").text
